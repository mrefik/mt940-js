...
var openingBalanceTag = tslib_1.__assign(tslib_1.__assign({}, getInitialState()), { readToken: function (state) {
        ...
        this.info.value = parseFloat((0, buffer_to_text_1.default)(this.balance));
    } });
